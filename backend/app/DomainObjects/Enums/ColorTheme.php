    ...
    public function getThemeData(): array
    {
        return match ($this) {
            ...
            self::MODERN => [
                ...
                'homepage_background_color' => '#1a1a2e', // Azul escuro
                'homepage_content_background_color' => '#16213ebf', // Azul escuro mais claro
                'homepage_primary_color' => '#8b5cf6', // Roxo (cor principal stubticket)
                'homepage_primary_text_color' => '#ffffff',
                'homepage_secondary_color' => '#6366f1', // Azul/roxo
                'homepage_secondary_text_color' => '#ffffff',
            ],
            self::OCEAN => [
